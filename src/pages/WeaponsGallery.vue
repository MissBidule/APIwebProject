<template>
    ...
    />
      <div class="Weapons-gallery">
        ...
        <div class="type-list">
          <ul>
            <li><router-link :to="{ name: 'armorsTypeGallery', params: { type: 'great-sword'}}">Great sword</router-link></li>
            <li><router-link :to="{ name: 'armorsTypeGallery', params: { type: 'long-sword'}}">Long sword</router-link></li>
            <li><router-link :to="{ name: 'armorsTypeGallery', params: { type: 'sword-and-shield'}}">Sword and shield</router-link></li>
            <li><router-link :to="{ name: 'armorsTypeGallery', params: { type: 'dual-blades'}}">Dual blades</router-link></li>
            <li><router-link :to="{ name: 'armorsTypeGallery', params: { type: 'hammer'}}">Hammer</router-link></li>
            <li><router-link :to="{ name: 'armorsTypeGallery', params: { type: 'hunting-horn'}}">Hunting horn</router-link></li>
            <li><router-link :to="{ name: 'armorsTypeGallery', params: { type: 'lance'}}">Lance</router-link></li>
            <li><router-link :to="{ name: 'armorsTypeGallery', params: { type: 'gunlance'}}">Gunlance</router-link></li>
            <li><router-link :to="{ name: 'armorsTypeGallery', params: { type: 'switch-axe'}}">Switch axe</router-link></li>
            <li><router-link :to="{ name: 'armorsTypeGallery', params: { type: 'charge-blade'}}">Charge blade</router-link></li>
            <li><router-link :to="{ name: 'armorsTypeGallery', params: { type: 'insect-glaive'}}">Insect glaive</router-link></li>
            <li><router-link :to="{ name: 'armorsTypeGallery', params: { type: 'light-bowgun'}}">Light bowgun</router-link></li>
            <li><router-link :to="{ name: 'armorsTypeGallery', params: { type: 'heavy-bowgun'}}">Heavy bowgun</router-link></li>
            <li><router-link :to="{ name: 'armorsTypeGallery', params: { type: 'bow'}}">Bow</router-link></li>
          </ul>
        </div>
        <SortOptions 
        ...
        <div v-if="weaponsData[0]" class="gallery">
          <span v-for="(n,index) in resultsNB" :key="n">
            <AllWeaponSample 
              ...
              :type="weaponsOrganizedData[index].type"
  ...
  <script>
    ...
    import AllWeaponSample from '@/components/AllWeaponSample.vue'
